...
#ifndef RIO_UI_MSGS__SRV__DETAIL__QR_CHECK__FUNCTIONS_H_
#define RIO_UI_MSGS__SRV__DETAIL__QR_CHECK__FUNCTIONS_H_
...
/// Initialize srv/QRCheck message.
/**
...
/// Create srv/QRCheck message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rio_ui_msgs__srv__QRCheck_Request__init().
...
/// Destroy srv/QRCheck message.
/**
 * It calls
 * rio_ui_msgs__srv__QRCheck_Request__fini()
...
/// Check for srv/QRCheck message equality.
/**
...
/// Initialize array of srv/QRCheck messages.
/**
...
/// Finalize array of srv/QRCheck messages.
/**
 * It calls
 * rio_ui_msgs__srv__QRCheck_Request__fini()
...
/// Create array of srv/QRCheck messages.
/**
 * It allocates the memory for the array and calls
 * rio_ui_msgs__srv__QRCheck_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/QRCheck messages.
/**
 * It calls
 * rio_ui_msgs__srv__QRCheck_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/QRCheck message array equality.
/**
...
/// Copy an array of srv/QRCheck messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rio_ui_msgs__srv__QRCheck_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rio_ui_msgs
...
/**
 * It calls
 * rio_ui_msgs__srv__QRCheck_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rio_ui_msgs
...
/**
 * It allocates the memory for the array and calls
 * rio_ui_msgs__srv__QRCheck_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rio_ui_msgs
...
/**
 * It calls
 * rio_ui_msgs__srv__QRCheck_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RIO_UI_MSGS__SRV__DETAIL__QR_CHECK__FUNCTIONS_H_
