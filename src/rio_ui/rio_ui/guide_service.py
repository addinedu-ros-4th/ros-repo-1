...
# from rio_ui.admin_service import DBConnector

# class UserRegisterInfo(Node):
#     def __init__(self):
#         super().__init__()
#         self.db_connector = DBConnector()

#     def registerinfo(self, user_info):
#         self.db_connector.db_manager.create("UserInfo", user_info)


# class CommuteInfo(Node):
#     def __init__(self):
#         super().__init__()
#         self.db_connector = DBConnector()

#     def commuteinfo(self, bool):
#         pass
...
class ROSGuideNodeSignals(QObject):
    ...
    update_name_signal = pyqtSignal(list)
...
class FacenameSubscriber(Node):
    ...
    def names_callback(self, data):
        try:
            ...
            print('names_callback! = ', self.names)
            self.signals.update_name_signal.emit(self.names)
